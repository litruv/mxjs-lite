...
**Signature:** `async editMessage(roomId, eventId, newMessage)`
...
**Signature:** `async getEvent(roomId, eventId)`
...
**Signature:** `async getEventByTimestamp(roomId, timestamp, dir = "f")`
...
**Signature:** `async getEventContext(roomId, eventId, { limit = 10 } = {})`
...
**Signature:** `async getEventRelations(roomId, eventId, { from = null, limit = 50 } = {})`
...
## getEventRelationsByType()

**Signature:** `async getEventRelationsByType(roomId, eventId, relType, { from = null, limit = 50 } = {})`
...
## getEventRelationsByTypeAndEvent()

**Signature:** `async getEventRelationsByTypeAndEvent(roomId, eventId, relType, eventType, { from = null, limit = 50 } = {})`
...
**Signature:** `async getJoinedMembers(roomId)`
...
**Signature:** `async getMessages(roomId, { from = null, limit = 50, dir = "b" } = {})`
...
**Signature:** `async getRoomAllState(roomId)`
...
**Signature:** `async getRoomName(roomId)`
...
**Signature:** `async getRoomState(roomId, type, stateKey = "")`
...
**Signature:** `async getRoomTopic(roomId)`
...
**Signature:** `async getThreads(roomId, { from = null, limit = 50, include = "all" } = {})`
...
**Signature:** `async reactToMessage(roomId, eventId, reaction)`
...
**Signature:** `async redactEvent(roomId, eventId, reason = "")`
...
**Signature:** `async removeReaction(roomId, reactionEventId)`
...
**Signature:** `async sendEvent(roomId, eventType, content, txnId = null)`
...
**Signature:** `async sendImage(roomId, url, body = "Image", info = {})`
...
**Signature:** `async sendMessage(roomId, message, formattedBody = null)`
...
**Signature:** `async sendStateEvent(roomId, type, content, stateKey = "")`
...
**Signature:** `async setRoomAvatar(roomId, url)`
...
**Signature:** `async setRoomName(roomId, name)`
...
**Signature:** `async setRoomTopic(roomId, topic)`
